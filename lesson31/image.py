...
background_image = pygame.transform.scale(
    pygame.image.load('lesson31/simple.jpg').convert(),
    (SCREEN_WIDTH, SCREEN_HEIGHT))

penguin_image = pygame.transform.scale(
    pygame.image.load('lesson31/cute-penguin-animal-cartoon-icon-isolated_1246656-515.avif').convert_alpha(), (200, 200))
